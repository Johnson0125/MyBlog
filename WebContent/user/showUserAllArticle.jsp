...
<body topmargin="0" leftmargin="0" bgcolor="#F3F3F3">
	...
	<table width="1000" border="0" cellpadding="0" cellspacing="0"
		...
		<tr height="30" valign="bottom">
			<td class="title">
			&nbsp;&nbsp;我的全部文章
			<img alt="订阅rss" src="image/feeds.gif"><a href="showRSS.action">订阅</a>
			</td>
		</tr>
		<tr>
								...
								<s:iterator value="#request.all" id="art">
									<tr>
										<td bgcolor="#FFFFFF"><font class="chinesefont105main">
												<!-- 文章标题  --> <a
												href="showArticle.action?id=<s:property value='#art.id'/>&username=<s:property value='#art.username'/>"><s:property value="#art.title" /></a>
												...
												<div align='right' class='smalltxt' height='32px'>
													...
													<!-- 评论与点击数 
													|评论(<s:property value="#request.critiqueCounts[#art.id - 1]" />) -->
													
													|点击(<s:property value="#art.hasread" />)
												</div>
										</font></td>
									</tr>
