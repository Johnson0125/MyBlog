...
<body topmargin="0" leftmargin="0" bgcolor="#f3f3f3">
		...
		<form id="Form1" action="resetPassword.action" method="post">
		      <!--  
		                  <tr height="30" align="center">
                                 <td>请输入验证信息</td>
                                <td > ${ request.info}</td>
                            </tr>
                             <p align="center"><td>请输入验证信息</td> <td > ${ request.info}</td></p> 
                            -->
			...
			<table width="1000" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td align="right" width="300" valign="top"><img src="image/reset.jpg"></td>
					<td width="20">&nbsp;</td>
					<td valign="top">
